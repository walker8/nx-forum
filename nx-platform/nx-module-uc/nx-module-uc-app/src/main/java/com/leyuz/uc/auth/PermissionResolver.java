...
public class PermissionResolver {
    ...
    public boolean hasPermission(String permission, String roleScope, String defaultRoleKey) {
        return authApplication.hasPermission(HeaderUtils.getUserId(), permission, roleScope, defaultRoleKey);
    }
    ...
    public boolean hasRole(String roleKey, String roleScope, String defaultRoleKey) {
        return authApplication.hasRole(HeaderUtils.getUserId(), roleKey, roleScope, defaultRoleKey);
    }
    ...
    public boolean hasAnyPermissions(String permissions, String roleScope, String defaultRoleKey) {
        return authApplication.hasAnyPermissions(HeaderUtils.getUserId(), permissions, roleScope, defaultRoleKey);
    }
    ...
    public boolean hasAnyRoles(String roleKeys, String roleScope, String defaultRoleKey) {
        return authApplication.hasAnyRoles(HeaderUtils.getUserId(), roleKeys, roleScope, defaultRoleKey);
    }
