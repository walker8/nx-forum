...
import com.leyuz.uc.auth.dto.UserRoleDTO;
...
import com.leyuz.uc.auth.role.mybatis.IUserRoleService;
...
public class UserRoleApplication {
    ...
    public List<UserRoleDTO> listByUserId(Long userId) {
        List<UserRolePO> userRolePOList = userRoleService.listValidRolesByUserId(userId);
    ...
    public boolean assign(UserRoleCreateCmd userRoleCreateCmd) {
        ...
        return userRoleService.save(userRolePO);
    }
    ...
    public boolean cancel(Long userId, String roleScope, String roleKey) {
        // 获取用户的所有有效角色
        List<UserRolePO> userRoles = userRoleService.listValidRolesByUserId(userId).stream()
        ...
        return userRoleService.cancel(userId, roleScope, roleKey);
    }

    public List<UserRoleDTO> listByRoleKey(String roleKey) {
        List<UserRolePO> userRoles = userRoleService.listByRoleKey(roleKey);
    ...
    public CustomPage<UserRoleVO> pageUserRoles(UserRolePageQuery query) {
        ...
        Page<UserRolePO> page = userRoleService.queryUserRoles(pageQuery);
