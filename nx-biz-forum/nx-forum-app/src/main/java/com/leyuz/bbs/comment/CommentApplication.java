...
import com.leyuz.bbs.comment.convert.CommentConvert;
import com.leyuz.bbs.comment.dto.*;
...
import com.leyuz.bbs.domain.comment.service.CommentDomainService;
...
public class CommentApplication {
    ...
    public CustomPage<AdminCommentVO> queryCommentsByAdmin(CommentQuery query) {
        ...
        Page<CommentPO> commentPOPage = commentService.queryComments(query.getForumId(), pageQuery);
    ...
    public CustomPage<AdminCommentReplyVO> queryCommentRepliesByAdmin(CommentReplyQuery query) {
        ...
        params.put("auditStatus", query.getAuditStatusV());
        params.put("isDeleted", query.getDeleted());
        Page<CommentReplyPO> commentReplyPOPage = commentReplyService.queryCommentReplies(query.getForumId(), pageQuery);
