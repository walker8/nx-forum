...
import com.leyuz.bbs.like.dto.LikeCmd;
import com.leyuz.bbs.like.mybatis.ILikeService;
...
public class LikeApplication {
    ...
    public int toggleLike(LikeCmd cmd) {
        ...
        LikePO existingLike = likeService.findByUserAndTarget(HeaderUtils.getUserId(), cmd.getTargetType(), cmd.getTargetId());
    ...
    public Table<Long, Integer, Boolean> getUserLikesByThreadId(Long threadId) {
        ...
        List<LikePO> likePOList = likeService.getUserLikes(userId, threadId);
