...
import com.leyuz.bbs.audit.AuditApplication;
import com.leyuz.bbs.audit.dto.AuditDTO;
...
import com.leyuz.bbs.domain.thread.service.ThreadDomainService;
import com.leyuz.bbs.favorite.FavoriteApplication;
import com.leyuz.bbs.forum.ForumApplication;
import com.leyuz.bbs.forum.ForumPO;
import com.leyuz.bbs.like.LikeApplication;
import com.leyuz.bbs.like.dto.LikeTargetType;
import com.leyuz.bbs.thread.dto.*;
import com.leyuz.bbs.thread.mybatis.IThreadService;
import com.leyuz.bbs.thread.plugin.ThreadPluginManager;
import com.leyuz.bbs.thread.strategy.ForumThreadQueryStrategy;
import com.leyuz.bbs.thread.strategy.ThreadQueryStrategyFactory;
...
public class ThreadApplication {
    ...
    public void createThread(Integer forumId, ThreadCmd threadCmd) {
        ...
        // 下载远程图片到本地
        threadCmd.setContent(downloadImages(threadCmd.getContent()));
        // 初始化帖子
    ...
    private void updateThreadViewsAsync(Long threadId) {
        ...
        threadViewCache.computeIfAbsent(threadId + ":" + ip, key -> {
            CompletableFuture.runAsync(() -> threadService.updateViews(threadId, 1));
            return true;
        });
    }
    ...
    public CustomPage<ThreadVO> queryThreadsByUserId(Long userId, int pageNo, int pageSize) {
        ...
        Page<ThreadPO> threadPOPage = threadService.queryThreads(0, pageQuery);
        return DataBaseUtils.createCustomPage(threadPOPage, threadConvert::convertThreadPO2VO);
    }
