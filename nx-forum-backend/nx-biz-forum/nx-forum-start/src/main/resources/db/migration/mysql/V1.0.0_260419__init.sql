...
-- ----------------------------
-- Table structure for bbs_access_logs
-- ----------------------------
CREATE TABLE `bbs_access_logs` (
  ...
  `platform` varchar(50) NOT NULL DEFAULT '' COMMENT '平台名称（Windows/Android/iOS等）',
...
-- ----------------------------
-- Table structure for bbs_comment_replies
-- ----------------------------
CREATE TABLE `bbs_comment_replies` (
  ...
  `user_ip` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '发帖时用户ip地址',
  `user_agent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '客户端useragent',
  `terminal_type` varchar(20) NOT NULL DEFAULT '' COMMENT '终端类型（PC/MOBILE/APP）',
  `platform` varchar(50) NOT NULL DEFAULT '' COMMENT '平台（Windows/Mac/Android/iPhone等）',
  ...
  KEY `bbs_comment_replies_create_time_platform_IDX` (`create_time`, `platform`) USING BTREE,
  KEY `bbs_comment_replies_create_time_terminal_platform_IDX` (`create_time`, `terminal_type`, `platform`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='楼中楼评论';

-- ----------------------------
-- Table structure for bbs_comments
-- ----------------------------
CREATE TABLE `bbs_comments` (
  ...
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '内容，用户提示的原始数据',
  ...
  KEY `bbs_comments_create_time_platform_IDX` (`create_time`, `platform`) USING BTREE,
  KEY `bbs_comments_create_time_terminal_platform_IDX` (`create_time`, `terminal_type`, `platform`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='评论';

-- ----------------------------
-- Table structure for bbs_custom_page_contents
-- ----------------------------
...
-- ----------------------------
-- Table structure for bbs_custom_pages
-- ----------------------------
CREATE TABLE `bbs_custom_pages` (
  ...
  `layout` varchar(20) NOT NULL DEFAULT 'default' COMMENT '布局类型（default默认 simple简洁 empty无布局）',
  `create_by` bigint unsigned NOT NULL DEFAULT 0 COMMENT '创建者',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_by` bigint unsigned NOT NULL DEFAULT 0 COMMENT '更新者',
  `update_time` datetime NOT NULL COMMENT '更新时间',
...
-- ----------------------------
-- Table structure for bbs_daily_stats
-- ----------------------------
CREATE TABLE `bbs_daily_stats` (
  ...
  `platform` varchar(50) NOT NULL DEFAULT 'ALL' COMMENT '平台（ALL表示全部，iPhone统一为iPhone）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`stat_id`) USING BTREE,
  UNIQUE KEY `uk_date_terminal_platform` (`stat_date`, `terminal_type`, `platform`) USING BTREE,
...
-- ----------------------------
-- Table structure for bbs_forums
-- ----------------------------
CREATE TABLE `bbs_forums` (
  `forum_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '版块ID',
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '版块号，只能用英文或数字',
  `nick_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '版块名称',
  `short_brief` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '版块20字短介绍 纯文本',
  ...
  `icon_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '版块图标',
  `seo_title` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'SEO 标题，如果设置会代替版块名称',
  `seo_keywords` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'SEO关键字，不要超过6个，关键字之间用英文的,隔开',
  `seo_content` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'SEO content',
  `seo_ext` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'SEO帖子后缀，保留',
  `background_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '版块背景图片',
...
-- ----------------------------
-- Table structure for bbs_images
-- ----------------------------
...
-- ----------------------------
-- Table structure for bbs_notifications
-- ----------------------------
...
-- ----------------------------
-- Table structure for bbs_reports
-- ----------------------------
CREATE TABLE `bbs_reports` (
   ...
   `user_ip` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '举报人IP地址',
...
-- ----------------------------
-- Table structure for bbs_thread_contents
-- ----------------------------
...
-- ----------------------------
-- Table structure for bbs_thread_properties
-- ----------------------------
...
CREATE TABLE `bbs_threads` (
  ...
  `terminal_type` varchar(20) NOT NULL DEFAULT '' COMMENT '终端类型（PC/MOBILE/APP）',
  `platform` varchar(50) NOT NULL DEFAULT '' COMMENT '平台（Windows/Mac/Android/iPhone等）',
  `subject` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '主题名称',
  ...
  KEY `bbs_threads_create_time_platform_IDX` (`create_time`, `platform`) USING BTREE,
  KEY `bbs_threads_create_time_terminal_platform_IDX` (`create_time`, `terminal_type`, `platform`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Table structure for bbs_user_bans
-- ----------------------------
...
-- ----------------------------
-- Table structure for bbs_user_favorites
-- ----------------------------
...
-- ----------------------------
-- Table structure for bbs_user_follows
-- ----------------------------
...
-- ----------------------------
-- Table structure for bbs_user_likes
-- ----------------------------
...
-- ----------------------------
-- Table structure for bbs_user_properties
-- ----------------------------
...
-- ----------------------------
-- Table structure for uc_role_permissions
-- 使用 perms 字符串关联（原 perm_id 关联已被重构）
-- ----------------------------
CREATE TABLE `uc_role_permissions` (
  ...
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '删除标志（0代表存在 1代表删除）',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_role_permissions_role_key` (`role_key`, `is_deleted`) USING BTREE
...
-- ----------------------------
-- Table structure for uc_user_login_tokens
-- ----------------------------
...
-- ----------------------------
-- Table structure for uc_user_logs
-- ----------------------------
...
-- ----------------------------
-- Table structure for uc_user_roles
-- ----------------------------
CREATE TABLE `uc_user_roles` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `user_id` bigint unsigned NOT NULL COMMENT '用户ID',
  `role_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '角色key',
...
-- bbs_custom_pages 数据
-- ----------------------------
INSERT INTO `bbs_custom_pages` VALUES (1,'关于我们','about',0,0,'simple',1,NOW(),1,NOW(),0);
INSERT INTO `bbs_custom_pages` VALUES (2,'用户协议','agreement',0,0,'simple',1,NOW(),1,NOW(),0);
INSERT INTO `bbs_custom_pages` VALUES (3,'隐私政策','privacy',0,0,'simple',1,NOW(),1,NOW(),0);

-- ----------------------------
-- bbs_forums 数据
-- ----------------------------
INSERT INTO `bbs_forums` VALUES (1,'follow','关注','','',0,'tabler:eye','','','','','',1,1,1,1,NOW(),1,NOW(),0);
INSERT INTO `bbs_forums` VALUES (2,'all','全部','','全部版块帖子，按回帖时间排序',0,'tabler:layout-grid','','','','','',1,2,1,1,NOW(),1,NOW(),0);
INSERT INTO `bbs_forums` VALUES (3,'newest','最新','','NX Forum 是一个基于 Spring Boot + Nuxt 构建的现代化开源论坛系统',0,'tabler:star','','','','','',1,3,1,1,NOW(),1,NOW(),0);
INSERT INTO `bbs_forums` VALUES (4,'recommend','推荐','','',0,'tabler:thumb-up','','','','','',0,4,1,1,NOW(),1,NOW(),0);
INSERT INTO `bbs_forums` VALUES (5,'digest','精华','','',0,'tabler:book','','','','','',0,5,1,1,NOW(),1,NOW(),0);
INSERT INTO `bbs_forums` VALUES (6,'hot','热门','','',0,'tabler:flame','','','','','',0,6,1,1,NOW(),1,NOW(),0);
INSERT INTO `bbs_forums` VALUES (7,'archive','归档','','归档版块，存储已归档的主题',0,'tabler:archive','','','','','',0,7,1,1,NOW(),1,NOW(),0);
INSERT INTO `bbs_forums` VALUES (11,'test','测试','这是一个测试版块的简介，你可以删除或者修改它','这是一个测试版块的详细介绍，你可以删除或者修改它',0,'tabler:brand-speedtest','','','','','',1,11,0,1,NOW(),1,NOW(),0);

-- ----------------------------
-- bbs_user_properties 数据
-- ----------------------------
...
-- common_configs 数据
-- ----------------------------
INSERT INTO `common_configs` VALUES (1,'default_forum_id','3',0,'默认首页',1,NOW(),1,NOW(),0);
...
-- ========== 用户权限树 ==========
INSERT INTO `uc_permissions` VALUES (1,0,'用户权限',0,'',1,1,'',1,NOW(),1,NOW(),0);
-- -- 主题管理
INSERT INTO `uc_permissions` VALUES (2,1,'主题管理',0,'',1,1,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (3,2,'查看主题',0,'thread:view',3,0,'查看帖子的权限',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (4,2,'新建主题',0,'thread:new',3,1,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (5,2,'编辑帖子',0,'thread:edit',3,2,'编辑帖子的权限',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (6,2,'删除主题',0,'thread:delete',3,3,'',1,NOW(),1,NOW(),0);
-- -- 评论管理
INSERT INTO `uc_permissions` VALUES (7,1,'评论管理',0,'',1,2,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (8,7,'新建评论',0,'comment:new',3,0,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (9,7,'删除评论',0,'comment:delete',3,1,'',1,NOW(),1,NOW(),0);
-- -- 访问论坛
INSERT INTO `uc_permissions` VALUES (10,1,'访问论坛',0,'forum:visit',2,0,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (11,10,'访问版块',0,'forum:visit:section',3,0,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (12,10,'访问其他',0,'forum:visit:other',3,1,'',1,NOW(),1,NOW(),0);
-- -- 附件上传
INSERT INTO `uc_permissions` VALUES (13,1,'附件上传',0,'',1,3,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (14,13,'上传头像',0,'avatar:upload',3,1,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (15,13,'上传图片',0,'image:upload',3,2,'',1,NOW(),1,NOW(),0);

-- ========== 管理权限树 ==========
INSERT INTO `uc_permissions` VALUES (16,0,'管理权限',0,'admin:manage',2,2,'',1,NOW(),1,NOW(),0);
-- -- 管理首页
INSERT INTO `uc_permissions` VALUES (17,16,'管理首页',0,'admin:home',2,0,'',1,NOW(),1,NOW(),0);
-- -- 系统管理
INSERT INTO `uc_permissions` VALUES (18,16,'系统管理',0,'admin:system',2,1,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (19,18,'基本设置',0,'admin:system:basic',2,0,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (20,18,'统计设置',0,'admin:system:analytics',2,1,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (21,18,'版块管理',0,'admin:system:forum',2,2,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (22,18,'审核设置',0,'admin:system:audit',2,3,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (23,18,'自定义页面',0,'admin:system:page',2,4,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (24,18,'图片管理',0,'admin:system:image',2,5,'',1,NOW(),1,NOW(),0);
-- -- 帖子管理
INSERT INTO `uc_permissions` VALUES (25,16,'帖子管理',0,'admin:thread',2,2,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (26,25,'主题查询',0,'admin:thread:search',2,0,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (27,26,'删除主题',0,'admin:thread:delete',3,0,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (28,26,'置顶主题',0,'admin:thread:top',3,1,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (29,26,'关闭主题',0,'admin:thread:close',3,2,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (30,26,'主题精华',0,'admin:thread:digest',3,3,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (31,26,'推荐主题',0,'admin:thread:recommend',3,4,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (32,26,'转移主题',0,'admin:thread:transfer',3,5,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (33,26,'编辑主题',0,'admin:thread:edit',3,6,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (34,26,'还原主题',0,'admin:thread:restore',3,7,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (35,26,'通过主题',0,'admin:thread:pass',3,8,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (36,26,'拒绝主题',0,'admin:thread:reject',3,9,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (37,25,'评论查询',0,'admin:comment:search',2,1,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (38,37,'删除评论',0,'admin:comment:delete',3,0,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (39,37,'通过评论',0,'admin:comment:pass',3,1,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (40,37,'拒绝评论',0,'admin:comment:reject',3,2,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (41,37,'还原评论',0,'admin:comment:restore',3,3,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (42,25,'用户举报',0,'admin:user:report',2,2,'',1,NOW(),1,NOW(),0);
-- -- 统计数据
INSERT INTO `uc_permissions` VALUES (43,16,'统计数据',0,'admin:stats',2,3,'论坛统计数据查询权限',1,NOW(),1,NOW(),0);
-- -- 用户管理
INSERT INTO `uc_permissions` VALUES (44,16,'用户管理',0,'admin:user',2,4,'',1,NOW(),1,NOW(),0);
INSERT INTO `uc_permissions` VALUES (45,44,'小黑屋',0,'admin:user:ban',2,0,'',1,NOW(),1,NOW(),0);
...
-- 游客权限
INSERT INTO `uc_role_permissions` VALUES (1,'GUEST','forum:visit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (2,'GUEST','forum:visit:section',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (3,'GUEST','forum:visit:other',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (4,'GUEST','thread:view',1,NOW(),1,NOW(),0);

-- 注册用户权限
INSERT INTO `uc_role_permissions` VALUES (5,'USER','forum:visit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (6,'USER','forum:visit:section',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (7,'USER','thread:view',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (8,'USER','thread:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (9,'USER','thread:edit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (10,'USER','comment:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (11,'USER','avatar:upload',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (12,'USER','image:upload',1,NOW(),1,NOW(),0);

-- 禁言用户权限
INSERT INTO `uc_role_permissions` VALUES (13,'MUTED_USER','forum:visit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (14,'MUTED_USER','forum:visit:section',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (15,'MUTED_USER','thread:view',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (16,'MUTED_USER','avatar:upload',1,NOW(),1,NOW(),0);

-- 内容创作者权限
INSERT INTO `uc_role_permissions` VALUES (17,'CREATOR','forum:visit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (18,'CREATOR','forum:visit:section',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (19,'CREATOR','forum:visit:other',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (20,'CREATOR','thread:view',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (21,'CREATOR','thread:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (22,'CREATOR','thread:edit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (23,'CREATOR','thread:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (24,'CREATOR','comment:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (25,'CREATOR','comment:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (26,'CREATOR','avatar:upload',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (27,'CREATOR','image:upload',1,NOW(),1,NOW(),0);

-- 论坛管理员权限（全部权限）
INSERT INTO `uc_role_permissions` VALUES (28,'ADMIN','forum:visit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (29,'ADMIN','forum:visit:section',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (30,'ADMIN','forum:visit:other',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (31,'ADMIN','thread:view',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (32,'ADMIN','thread:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (33,'ADMIN','thread:edit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (34,'ADMIN','thread:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (35,'ADMIN','comment:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (36,'ADMIN','comment:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (37,'ADMIN','avatar:upload',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (38,'ADMIN','image:upload',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (39,'ADMIN','admin:manage',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (40,'ADMIN','admin:home',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (41,'ADMIN','admin:system',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (42,'ADMIN','admin:system:basic',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (43,'ADMIN','admin:system:analytics',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (44,'ADMIN','admin:system:forum',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (45,'ADMIN','admin:system:audit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (46,'ADMIN','admin:system:page',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (47,'ADMIN','admin:system:image',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (48,'ADMIN','admin:thread',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (49,'ADMIN','admin:thread:search',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (50,'ADMIN','admin:thread:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (51,'ADMIN','admin:thread:top',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (52,'ADMIN','admin:thread:close',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (53,'ADMIN','admin:thread:digest',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (54,'ADMIN','admin:thread:recommend',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (55,'ADMIN','admin:thread:transfer',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (56,'ADMIN','admin:thread:edit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (57,'ADMIN','admin:thread:restore',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (58,'ADMIN','admin:thread:pass',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (59,'ADMIN','admin:thread:reject',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (60,'ADMIN','admin:comment:search',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (61,'ADMIN','admin:comment:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (62,'ADMIN','admin:comment:pass',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (63,'ADMIN','admin:comment:reject',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (64,'ADMIN','admin:comment:restore',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (65,'ADMIN','admin:user:report',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (66,'ADMIN','admin:user',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (67,'ADMIN','admin:user:ban',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (68,'ADMIN','admin:stats',1,NOW(),1,NOW(),0);

-- 超级版主权限
INSERT INTO `uc_role_permissions` VALUES (69,'SUPER_MODERATOR','forum:visit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (70,'SUPER_MODERATOR','forum:visit:section',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (71,'SUPER_MODERATOR','forum:visit:other',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (72,'SUPER_MODERATOR','thread:view',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (73,'SUPER_MODERATOR','thread:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (74,'SUPER_MODERATOR','thread:edit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (75,'SUPER_MODERATOR','thread:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (76,'SUPER_MODERATOR','comment:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (77,'SUPER_MODERATOR','comment:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (78,'SUPER_MODERATOR','avatar:upload',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (79,'SUPER_MODERATOR','image:upload',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (80,'SUPER_MODERATOR','admin:manage',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (81,'SUPER_MODERATOR','admin:thread',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (82,'SUPER_MODERATOR','admin:thread:search',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (83,'SUPER_MODERATOR','admin:thread:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (84,'SUPER_MODERATOR','admin:thread:top',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (85,'SUPER_MODERATOR','admin:thread:close',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (86,'SUPER_MODERATOR','admin:thread:digest',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (87,'SUPER_MODERATOR','admin:thread:recommend',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (88,'SUPER_MODERATOR','admin:thread:transfer',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (89,'SUPER_MODERATOR','admin:thread:edit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (90,'SUPER_MODERATOR','admin:thread:restore',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (91,'SUPER_MODERATOR','admin:thread:pass',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (92,'SUPER_MODERATOR','admin:thread:reject',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (93,'SUPER_MODERATOR','admin:comment:search',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (94,'SUPER_MODERATOR','admin:comment:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (95,'SUPER_MODERATOR','admin:comment:pass',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (96,'SUPER_MODERATOR','admin:comment:reject',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (97,'SUPER_MODERATOR','admin:comment:restore',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (98,'SUPER_MODERATOR','admin:user:report',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (99,'SUPER_MODERATOR','admin:user',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (100,'SUPER_MODERATOR','admin:user:ban',1,NOW(),1,NOW(),0);

-- 版主权限
INSERT INTO `uc_role_permissions` VALUES (101,'MODERATOR','forum:visit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (102,'MODERATOR','forum:visit:section',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (103,'MODERATOR','forum:visit:other',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (104,'MODERATOR','thread:view',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (105,'MODERATOR','thread:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (106,'MODERATOR','thread:edit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (107,'MODERATOR','thread:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (108,'MODERATOR','comment:new',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (109,'MODERATOR','comment:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (110,'MODERATOR','avatar:upload',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (111,'MODERATOR','image:upload',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (112,'MODERATOR','admin:manage',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (113,'MODERATOR','admin:thread',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (114,'MODERATOR','admin:thread:search',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (115,'MODERATOR','admin:thread:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (116,'MODERATOR','admin:thread:top',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (117,'MODERATOR','admin:thread:close',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (118,'MODERATOR','admin:thread:digest',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (119,'MODERATOR','admin:thread:recommend',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (120,'MODERATOR','admin:thread:transfer',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (121,'MODERATOR','admin:thread:edit',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (122,'MODERATOR','admin:thread:restore',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (123,'MODERATOR','admin:thread:pass',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (124,'MODERATOR','admin:thread:reject',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (125,'MODERATOR','admin:comment:search',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (126,'MODERATOR','admin:comment:delete',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (127,'MODERATOR','admin:comment:pass',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (128,'MODERATOR','admin:comment:reject',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (129,'MODERATOR','admin:comment:restore',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (130,'MODERATOR','admin:user:report',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (131,'MODERATOR','admin:user',1,NOW(),1,NOW(),0);
INSERT INTO `uc_role_permissions` VALUES (132,'MODERATOR','admin:user:ban',1,NOW(),1,NOW(),0);
