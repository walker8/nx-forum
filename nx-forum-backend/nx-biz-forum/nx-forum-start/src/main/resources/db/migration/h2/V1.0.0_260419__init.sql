...
CREATE TABLE bbs_access_logs (
 ...
 user_id bigint NOT NULL DEFAULT 0 COMMENT '用户ID（0表示未登录）',
 ...
 KEY idx_access_time_ip (access_time, ip_address),
 KEY idx_access_time_terminal (access_time, terminal_type),
 KEY idx_access_time_user (access_time, user_id)
...
CREATE TABLE bbs_comment_replies (
 ...
 user_ip varchar(40) NOT NULL DEFAULT '' COMMENT '发帖时用户ip地址',
 ...
 KEY bbs_comment_replies_create_time_platform_IDX (create_time, platform),
 KEY bbs_comment_replies_create_time_terminal_platform_IDX (create_time, terminal_type, platform)
...
CREATE TABLE bbs_comments (
 ...
 KEY bbs_comments_create_time_platform_IDX (create_time, platform),
 KEY bbs_comments_create_time_terminal_platform_IDX (create_time, terminal_type, platform)
...
CREATE TABLE bbs_daily_stats (
 ...
 unique_ip_count int NOT NULL DEFAULT 0 COMMENT '独立IP访问数',
 guest_ip_count int NOT NULL DEFAULT 0 COMMENT '游客独立IP数',
 user_ip_count int NOT NULL DEFAULT 0 COMMENT '登录用户独立IP数',
 thread_count int NOT NULL DEFAULT 0 COMMENT '发帖数量',
 comment_count int NOT NULL DEFAULT 0 COMMENT '回帖数量',
 ...
 PRIMARY KEY (stat_id),
 UNIQUE KEY uk_date_terminal_platform (stat_date, terminal_type, platform),
...
CREATE TABLE bbs_forums (
 ...
 name varchar(20) NOT NULL DEFAULT '' COMMENT '版块号，只能用英文或数字',
 nick_name varchar(20) NOT NULL DEFAULT '' COMMENT '版块名称',
 short_brief varchar(40) NOT NULL DEFAULT '' COMMENT '版块20字短介绍 纯文本',
 ...
 icon_name varchar(50) NOT NULL DEFAULT '' COMMENT '版块图标',
 seo_title varchar(64) NOT NULL DEFAULT '' COMMENT 'SEO 标题，如果设置会代替版块名称',
 seo_keywords varchar(64) NOT NULL DEFAULT '' COMMENT 'SEO关键字，不要超过6个，关键字之间用英文的,隔开',
 seo_content varchar(200) NOT NULL DEFAULT '' COMMENT 'SEO content',
 seo_ext varchar(20) NOT NULL DEFAULT '' COMMENT 'SEO帖子后缀，保留',
 background_image varchar(255) NOT NULL DEFAULT '' COMMENT '版块背景图片',
...
CREATE TABLE bbs_reports (
 ...
 user_ip varchar(40) NOT NULL DEFAULT '' COMMENT '举报人IP地址',
...
CREATE TABLE bbs_threads (
 ...
 terminal_type varchar(20) NOT NULL DEFAULT '' COMMENT '终端类型（PC/MOBILE/APP）',
 platform varchar(50) NOT NULL DEFAULT '' COMMENT '平台（Windows/Mac/Android/iPhone等）',
 subject varchar(128) NOT NULL DEFAULT '' COMMENT '主题名称',
 ...
 KEY bbs_threads_create_time_platform_IDX (create_time, platform),
 KEY bbs_threads_create_time_terminal_platform_IDX (create_time, terminal_type, platform)
...
CREATE TABLE uc_role_permissions (
 ...
 is_deleted tinyint NOT NULL DEFAULT '0' COMMENT '删除标志（0代表存在 1代表删除）',
 PRIMARY KEY (id),
 KEY idx_role_permissions_role_key (role_key, is_deleted)
...
-- bbs_custom_pages 数据
-- ----------------------------
INSERT INTO bbs_custom_pages VALUES (1,'关于我们','about',0,0,'simple',1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_custom_pages VALUES (2,'用户协议','agreement',0,0,'simple',1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_custom_pages VALUES (3,'隐私政策','privacy',0,0,'simple',1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
-- ----------------------------
-- bbs_forums 数据
-- ----------------------------
INSERT INTO bbs_forums VALUES (1,'follow','关注','','',0,'tabler:eye','','','','','',1,1,1,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_forums VALUES (2,'all','全部','','全部版块帖子，按回帖时间排序',0,'tabler:layout-grid','','','','','',1,2,1,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_forums VALUES (3,'newest','最新','','NX Forum 是一个基于 Spring Boot + Nuxt 构建的现代化开源论坛系统',0,'tabler:star','','','','','',1,3,1,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_forums VALUES (4,'recommend','推荐','','',0,'tabler:thumb-up','','','','','',0,4,1,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_forums VALUES (5,'digest','精华','','',0,'tabler:book','','','','','',0,5,1,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_forums VALUES (6,'hot','热门','','',0,'tabler:flame','','','','','',0,6,1,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_forums VALUES (7,'archive','归档','','归档版块，存储已归档的主题',0,'tabler:archive','','','','','',0,7,1,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
INSERT INTO bbs_forums VALUES (11,'test','测试','这是一个测试版块的简介，你可以删除或者修改它','这是一个测试版块的详细介绍，你可以删除或者修改它',0,'tabler:brand-speedtest','','','','','',1,11,0,1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
-- ----------------------------
...
-- common_configs 数据
-- ----------------------------
INSERT INTO common_configs VALUES (1,'default_forum_id','3',0,'默认首页',1,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
...
INSERT INTO common_configs VALUES (9,'uc_login_config','{"enableEmailCodeLogin":true,"enableEmailResetPassword":true,"enableLoginCaptcha":true,"enablePasswordLogin":true,"enablePhoneCodeLogin":false,"enablePhoneResetPassword":false,"loginLockMinutes":30,"maxLoginFailCount":5}',0,'',0,CURRENT_TIMESTAMP,1,CURRENT_TIMESTAMP,0);
